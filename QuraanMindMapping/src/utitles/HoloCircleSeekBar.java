...
//		mAngle=(float)calculateAngleFromText(pos);
		arc_finish_radians =((int) calculateAngleFromText(Integer.valueOf(pos)) - 90);
	Log.d("TAG", pos+"%"+"arc finish radias "+arc_finish_radians);
//		if (arc_finish_radians > end_wheel) {
//			arc_finish_radians = end_wheel;
//			block_end = true;
//		}
...
//			
			Log.d("TAG", text+"% "+"arc_finish_radians "+arc_finish_radians+" angle from text "+((int) calculateAngleFromText(Integer.valueOf(69)) - 90));
//			Log.d("TAG", "mAngle "+mAngle+" "+arc_finish_radians);
			...
			if (mUserIsMovingPointer) {
				...
				if (mOnCircleSeekBarChangeListener != null)
					mOnCircleSeekBarChangeListener.onProgressChanged(this,
							Integer.parseInt(text), true);
//				Log.d(STATE_PARENT, "pointerPos"+pointerPosition[0]+" y "+pointerPosition[1]);
				last_radians = radians;
	...
	public interface OnCircleSeekBarChangeListener {
		...
		public abstract void onStartTrackingTouch(HoloCircleSeekBar seekBar,
				int progress, boolean fromUser) ;
		public abstract void onStopTrackingTouch(HoloCircleSeekBar seekBar,
				int progress, boolean fromUser) ;
	}
